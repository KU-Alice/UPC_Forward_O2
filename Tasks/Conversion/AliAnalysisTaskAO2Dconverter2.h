...
#ifndef AliAnalysisTaskAO2Dconverter2_H
#define AliAnalysisTaskAO2Dconverter2_H
...
class AliAnalysisTaskAO2Dconverter2 : public AliAnalysisTaskSE
{
public:
  AliAnalysisTaskAO2Dconverter2() = default;
  AliAnalysisTaskAO2Dconverter2(const char *name);
  virtual ~AliAnalysisTaskAO2Dconverter2();

  AliAnalysisTaskAO2Dconverter2(const AliAnalysisTaskAO2Dconverter2 &) = default;
  AliAnalysisTaskAO2Dconverter2 &operator=(const AliAnalysisTaskAO2Dconverter2 &) = delete;
  ...
  static AliAnalysisTaskAO2Dconverter2* AddTask(TString suffix = "");
...
private:
  ...
  ClassDef(AliAnalysisTaskAO2Dconverter2, 20);
};
