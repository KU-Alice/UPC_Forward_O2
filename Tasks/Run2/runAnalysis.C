...
void runAnalysis()
{
...
#if !defined (__CINT__) || defined (__CLING__)
    gInterpreter->LoadMacro("AliAnalysisTaskForwardO2Parallel.cxx++g");
    AliAnalysisTaskForwardO2Parallel *task = reinterpret_cast<AliAnalysisTaskForwardO2Parallel*>(gInterpreter->ExecuteMacro("AddMyTask.C"));
#else
    gROOT->LoadMacro("AliAnalysisTaskForwardO2Parallel.cxx++g");
    gROOT->LoadMacro("AddMyTask.C");
    AliAnalysisTaskForwardO2Parallel *task = AddMyTask();
#endif
    ...
    if(local) {
        ...
        chain->Add("/home/agautam/UPCForwardValidation/myRun2/data/AliESDs.root");
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisTaskForwardO2Parallel.cxx AliAnalysisTaskForwardO2Parallel.h");
        alienHandler->SetAnalysisSource("AliAnalysisTaskForwardO2Parallel.cxx");
